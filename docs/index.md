...
The DraCor Textbook is **distinct from the DraCor Notebooks**. While the notebooks document individual analyses, experiments, and research workflows, the textbook is designed as a structured curriculum, with clearly defined learning outcomes, practical examples, exercises, and teaching notes suitable for self-study and classroom use.
